...
mutation programInsert($licencedGroupId: UUID!, $guarantorsGroupId: UUID!, $id: UUID, $name: String, $nameEn: String, $typeId: UUID, $subjects: [SubjectInsertGQLModel!]) {
  programInsert(program: {licencedGroupId: $licencedGroupId, guarantorsGroupId: $guarantorsGroupId, id: $id, name: $name, nameEn: $nameEn, typeId: $typeId, subjects: $subjects}) {
