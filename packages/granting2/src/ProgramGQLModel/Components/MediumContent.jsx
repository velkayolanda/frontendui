...
export const MediumContent = ({ item }) => {
    return (<>
        ...
        <hr/>
        <Attribute label="Typ" item={item}>
            {item?.type?.name}
        </Attribute>
        <Attribute label="Jazyk" item={item}>
            {item?.type?.languageType?.name}
        </Attribute>
        <Attribute label="Úroveň" item={item}>
            {item?.type?.levelType?.name}
        </Attribute>
        <Attribute label="Forma" item={item}>
            {item?.type?.formType?.name}
        </Attribute>
        <Attribute label="Udělovaný titul" item={item}>
            {item?.type?.titleType?.name}
        </Attribute>
        <hr/>
        <Attribute label="Uskutečňovatel" item={item}>
            <BaseLink item={item?.licencedGroup} />
        </Attribute>
        <hr/>
        <Attribute label="Vytvořeno" item={item}>
            <BaseLink item={item?.createdby} /> @ {formatDateTime(item?.created)}
        </Attribute>
        <Attribute label="Změněno" item={item}>
            <BaseLink item={item?.changedby} /> @ {formatDateTime(item?.lastchange)}
        </Attribute>
