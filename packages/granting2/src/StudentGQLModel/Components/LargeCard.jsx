...
import { MediumCard as UserMediumCard } from "../../../../_template/src/UserGQLModel/Components/MediumCard"
import { MediumCard as ProgramMediumCard } from "../../ProgramGQLModel/Components/MediumCard"
...
export const LargeCard = ({ item, children, CardCapsule=CardCapsule_, MediumContent=MediumContent_ }) => {
    ...
    return (
        <CardCapsule item={item} >
            <Row>
                <LeftColumn>
                    <UserMediumCard item={item?.user} />
                    <ProgramMediumCard item={item?.program} />
