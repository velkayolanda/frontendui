...
export const MediumContent = ({ item }) => {
    return (<>
        <Attribute attribute_name="semesterNumber" label="Studovaný semestr" item={item}></Attribute>
        <Attribute label="Stav studia" item={item}>{item?.state?.name || item?.state?.id || "Neuložen"}</Attribute>
