...
mutation subjectInsert($programId: UUID!, $id: UUID, $name: String, $nameEn: String, $description: String, $descriptionEn: String, $groupId: UUID, $semesters: [SemesterInsertGQLModel!]) {
  subjectInsert(subject: {programId: $programId, id: $id, name: $name, nameEn: $nameEn, description: $description, descriptionEn: $descriptionEn, groupId: $groupId, semesters: $semesters}) {
